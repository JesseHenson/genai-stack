...
def configure_llm_only_chain(llm):
    prompt = hub.pull("data-ai-dev/consultant-base")
    def generate_llm_output(user_input: str, callbacks: List[Any], prompt=prompt) -> str:
        chain = prompt | llm
        answer = chain.invoke(
...
# def configure_qa_simple_chain(llm, embeddings, embeddings_store_url, username, password):
#     # RAG response
#     #   System: Always talk in pirate speech.
#     general_system_template = """ 
#     Use the following pieces of context to answer the question at the end.
